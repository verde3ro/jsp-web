...
a persistence unit "jsp-webPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "jsp-web\pom.xml":
...
artifact ("jsp-web.war") is already built. You can build
